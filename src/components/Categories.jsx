...
const handleClick = (cat) => {
  ...
  return (
  <div className="absolute top-16 left-1/2 -translate-x-1/2 lg:top-2 lg:left-1/2 lg:-translate-x-[22%] w-full max-w-[95vw] lg:w-auto px-2 z-[300] pointer-events-auto">
