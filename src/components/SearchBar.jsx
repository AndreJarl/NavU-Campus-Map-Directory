...
function SearchBar({searchTerm, suggestions, handleSearch, handleSuggestionClicked}) {
  ...
  return (
     <div className="fixed top-3  group right lg:right-10 2xl:right-36 2xl:top-6 px-2" >
            <div className=" rounded-lg border-x border border-gray-200  w-[300px] lg:w-[400px] 2xl:w-[600px]   px-5 flex flex-row justify-center items-center bg-white hover:rounded-t-xl">
            ...
            <div className={`bg-white rounded-b-lg shadow-md shadow-gray-500 max-h-[460px] overflow-auto flex-col gap-1 pt-2 py-2 items-start justify-start -mt-2 ${suggestions.length>0 ? 'flex' : 'hidden'}`
                }>
