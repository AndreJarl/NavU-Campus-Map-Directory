...
function RoomInfo({ setShowPopup, showPopup, roomSearched, setRoomSearched, setDisable, disable }) {
  ...
  return (
    <div
      ...
      } w-[35%] my-4 h-[80%] rounded-2xl  border-2 py-2 border-opacity-50 border-gray-400 bg-white shadow-2xl p-2 transform transition-transform ease-in-out duration-700 z-[1000] flex flex-col`}
    >
      {/* Close Button */}
