...
>
  ...
  <div className="absolute top-4 right-4 lg:top-auto items-center justify-center lg:bottom-4 lg:right-2 z-10 flex flex-col lg:flex-col gap-2">  
    <button
      onClick={handleZoomIn}
      className="w-5 h-5 lg:w-11 lg:h-11 bg-black/70 border border-gray-300 rounded-full shadow-md flex items-center justify-center hover:bg-black/80 active:bg-black/90 transition-colors"
      title="Zoom In"
    >
