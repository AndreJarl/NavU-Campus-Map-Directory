...
const Floor2 = forwardRef(({ viewBox, zooomBuildingbyName, OpenCard  }, ref) => {
...
<svg
  ...
  <rect xmlns="http://www.w3.org/2000/svg" x="136" y="562" width="16" height="21" transform="rotate(90 136 562)" fill="#00C3FF"/>
  <path fill="#d9d9d9" d="M267.666 522.974h3.64453v3H267.666z"/>
  <path fill="#d9d9d9" d="M114.062 522.543h3.64453v3H114.062z"/>
  <path fill="#ff6453" d="M126 723h8v5h8v21.085h-16z"/>
  <path fill="#ce4b46" d="M126 749.085h16V751h-16z"/>
...
{/* girl cr near cme */}
  <path fill={allFalse ? '#ff69eb'  : category["Restroom"] ? "#ff69eb" : "#B0B0B0" }  d="M272 528v15h-9v-15z"/>

  <path fill="#ff3030" d="M249 544h21v17h-21z"/>
  <path fill="#ff3030" d="M270 562v16h-21v-16z"/>
  <path fill="#ff3030" d="M270 579v17h-21v-17z"/>
  <path fill="#ff3030" d="M270 597v16h-21v-16z"/>
  <path fill="#00c3ff" d="M227 562v21h-22v-21z"/>
  <path fill={allFalse ? '#ff8000'  : category["Laboratory"] ? "#ff8000" : "#B0B0B0" } d="M205 540h22v21h-22z"/>
  <path fill={allFalse ? '#ff8000'  : category["Laboratory"] ? "#ff8000" : "#B0B0B0" } d="M227 584v21h-22v-21z"/>
  <path fill={allFalse ? '#ff8000'  : category["Laboratory"] ? "#ff8000" : "#B0B0B0" } d="M227 606v21h-22v-21z"/>

{/* girl cr near ceas */}
  <path fill={allFalse ? '#ff69eb'  : category["Restroom"] ? "#ff69eb" : "#B0B0B0" }  d="M113 528v15h9v-15z"/>

  <path fill="#00c3ff" d="M115 544h21v17h-21z"/>
  <path fill="#0080ff" d="m25.5078 522.63 17.3889326.63436844-1.55969218 42.75335977-17.3889326-.63436844z"/>
  <path fill="#00c3ff" d="M136 579v17h-21v-17z"/>

  {/* QUADRANGLE */}
  <path  fill={allFalse ? '#00ffae'  : category["Sports"] ? "#00ffae" : "#B0B0B0" } d="M195 589v51.391h-40V589z"/>
  <path  fill={allFalse ? '#00ca8a'  : category["Sports"] ? "#00ca8a" : "#B0B0B0" } d="M155 640.261h40V643h-40z"/>

  <path fill="#00ffae" d="M202 700v10.468h-18V700z"/>
  <path fill="#00ca8a" d="M184 709.721h18V711h-18z"/>
  <path fill="#00c3ff" d="M136 597v16h-21v-16z"/>
  <path fill={allFalse ? '#ff8000'  : category["Laboratory"] ? "#ff8000" : "#B0B0B0" } d="M62.457 486.005V494h-11l5.8236-7.995z"/>
  <path fill={allFalse ? '#ff8000'  : category["Laboratory"] ? "#ff8000" : "#B0B0B0" } d="M78 495v14H47v-7.881l2.4404-3.846L50.8946 495z"/>
  <path fill={allFalse ? '#ff8000'  : category["Laboratory"] ? "#ff8000" : "#B0B0B0" } d="M78 510v11H62v-11z"/>
  <path fill={allFalse ? '#ff8000'  : category["Laboratory"] ? "#ff8000" : "#B0B0B0" } d="M61 510v11H47v-11z"/>
  <path fill={allFalse ? '#ff8000'  : category["Laboratory"] ? "#ff8000" : "#B0B0B0" } d="M78 522v7H47v-7z"/>
  <path fill={allFalse ? '#ff8000'  : category["Laboratory"] ? "#ff8000" : "#B0B0B0" } d="M78 530v12H62v-12z"/>
  <path fill={allFalse ? '#ff8000'  : category["Laboratory"] ? "#ff8000" : "#B0B0B0" } d="M78 543v13H47v-26h13.9843v13z"/>
  ...
  <path fill="#ff3030" d="M270.002 614v30.514h-20.994V614z"/>
  <path fill="#c32525" d="M249.008 643.367h20.994v2.638h-20.994z"/>
  <path fill="#00ffae" d="m458.775 585.587-8.812 97.326-34.236-3.099 8.812-97.326z"/>
  <path fill="#00ca8a" d="m415.727 679.814 34.236 3.099-.431 4.756-34.235-3.1z"/>
  <path fill={allFalse ? '#ff8000'  : category["Laboratory"] ? "#ff8000" : "#B0B0B0" } d="M227 628v19.975h-22V628z"/>
  <path fill={allFalse ? '#ce6700'  : category["Laboratory"] ? "#ce6700" : "#B0B0B0" } d="M205 647.84h22V650h-22z"/>
  <path fill="#fc0" d="M78 598v6.452H47V598z"/>
  <path fill="#d6b018" d="M47 604.452h31V606H47z"/>
  <path fill={allFalse ? '#ff8000'  : category["Laboratory"] ? "#ff8000" : "#B0B0B0" } d="m41.3387 567.29-.7631 20.919-17.389-.635.7631-20.919z"/>
  <path fill={allFalse ? '#ce6700'  : category["Laboratory"] ? "#ce6700" : "#B0B0B0" } d="m23.22 586.659 17.3889.634-.0715 1.962-17.389-.635z"/>
  <path fill="#00c3ff" d="M136 614v30.564h-21V614z"/>
  <path fill="#0094cf" d="M115 643.357h21V646h-21z"/>

{/* CIVIL ENGINEERING LABBBBBBBBB */}
  <path onClick={()=>bldClicked("Civil Engineering Lab 1")} style={{cursor: "pointer"}} fill="#ff3030" d="M270 664v17h-21v-17z"/>

{/* electrical eng lab */}
  <path onClick={()=>bldClicked("Electrical Engineering Laboratory")} style={{cursor: "pointer"}}  fill="#ff3030" d="M270 682v16h-21v-16z"/>

  <path fill="#00c3ff" d="M136 664v17h-21v-17z"/>
  <path fill="#00c3ff" d="M136 682v16h-21v-16z"/>

  {/* woman cr near clinic */}
  <path  fill={allFalse ? '#ff69eb'  : category["Restroom"] ? "#ff69eb" : "#B0B0B0" } d="M249 699h24v8.938h-24z"/>
  <path fill={allFalse ? '#cf56bf'  : category["Restroom"] ? "#cf56bf" : "#B0B0B0" }   d="M249 707.938h24V710h-24z"/>

  {/* woman cr near accounting */}

  <path fill={allFalse ? '#ff69eb'  : category["Restroom"] ? "#ff69eb" : "#B0B0B0" }  d="M112 699h24v8.937h-24z"/>
  <path fill={allFalse ? '#cf56bf'  : category["Restroom"] ? "#cf56bf" : "#B0B0B0" } d="M112 707.937h24V710h-24z"/>


  <path fill="#ff6453" d="M143 728h15v21.021h-15z"/>
  <path fill="#ce4b46" d="M143 749.021h15V751h-15z"/>
  <path fill="#ff6453" d="M159 728h15v21.021h-15z"/>
  <path fill="#ce4b46" d="M159 749.021h15V751h-15z"/>
  <path fill="#ff6453" d="M261 730h15v18.279h-15z"/>
  <path fill="#ce4b46" d="M261 748.279h15V750h-15z"/>
  <path fill="#ff6453" d="M211 728h16v21.021h-16z"/>
  <path fill="#ce4b46" d="M211 749.021h16V751h-16z"/>
  <path fill="#ff6453" d="M228 728h15v21.021h-15z"/>
  <path fill="#ce4b46" d="M228 749.021h15V751h-15z"/>
  <path fill="#ff4c85" d="M152 542h9v-5h13.596v5.372h22.198v14.709H152z"/>
  <path fill="#d94272" d="M152 556.953h44.794V559H152z"/>
  <path fill="#ff6453" d="M244 728h8v-5h8v26.066h-16z"/>
  <path fill="#ce4b46" d="M244 749.066h16V751h-16z"/>
  <path fill="#ff4c85" d="M108 421h39v46h-39z"/>
  <path fill="#bf71ff" d="M132 468h14.956v7.283H132z"/>
  <path fill="#9e5ed3" d="M132 475.283h14.956v1.69H132z"/>
  ...
  <path fill="#00ffae" d="M156 562h19v20.648h-19z"/>
  <path fill="#00ca8a" d="M156 582.386h19V585h-19z"/>
...
{/* girl cr near cot */}
  <path  fill={allFalse ? '#ff69eb'  : category["Restroom"] ? "#ff69eb" : "#B0B0B0" } d="M184 484.161h6v6.68h-6z"/>
  <path  fill={allFalse ? '#cf56bf'  : category["Restroom"] ? "#cf56bf" : "#B0B0B0" }  d="M184 490.841h6v1.361h-6z"/>
{/* girl cr near cot */}
...
{/* girl cr near sac */}
  <path  fill={allFalse ? '#ff69eb'  : category["Restroom"] ? "#ff69eb" : "#B0B0B0" } d="M294 418h14v11h-14z"/>
{/* boy cr near sac */}
  <path  fill={allFalse ? '#73daff'  : category["Restroom"] ? "#73daff" : "#B0B0B0" }  d="M309 418h14v11h-14z"/>

{/* SAC */}
  <path fill={allFalse ? '#00ffae'  : category["Sports"] ? "#00ffae" : "#B0B0B0" } d="M294 430h29v77.135h-29z"/>
  <path fill={allFalse ? '#00ca8a'  : category["Sports"] ? "#00ca8a" : "#B0B0B0" }  d="M294 506.926h29V510h-29z"/>

  <path fill="#00ffae" d="M356 431v21h-23v-21z"/>
  <path fill="#f7ff5f" d="M356 453v21h-23v-21z"/>
  
  {/* kitchen lab */}
  <path fill={allFalse ? '#ff8000'  : category["Laboratory"] ? "#ff8000" : "#B0B0B0" } d="m355.997 475 .003 32.451h-22.997L333 475z"/>

  <path fill={allFalse ? '#ce6700'  : category["Laboratory"] ? "#ce6700" : "#B0B0B0" } d="M333.003 507.451H356V510h-22.997z"/>
  <path fill="#f7ff5f" d="m445.004 467.866-10.419 30.553-21.67-7.389 10.419-30.554z"/>
  <path fill="#cdd34f" d="m413.079 490.558 21.67 7.39-.805 2.362-21.671-7.389z"/>

{/* Tennis Court */}
  <path fill={allFalse ? '#00ffae'  : category["Sports"] ? "#00ffae" : "#B0B0B0" }  d="M326.039 387.31h70.959v32.582h-70.959z"/>

  <path fill={allFalse ? '#00ca8a'  : category["Sports"] ? "#00ca8a" : "#B0B0B0" }  d="M326.039 419.799h70.959V422h-70.959z"/>

{/* girl cr near electrical shop */}
  <path  fill={allFalse ? '#ff69eb'  : category["Restroom"] ? "#ff69eb" : "#B0B0B0" } d="M360 431h7v9.977h-7z"/>
  <path  fill={allFalse ? '#cf56bf'  : category["Restroom"] ? "#cf56bf" : "#B0B0B0" } d="M360 440.721h7V442h-7z"/>
...
{/* Kadasig Gym */}
  <path fill={allFalse ? '#00ffae'  : category["Sports"] ? "#00ffae" : "#B0B0B0" }  d="m345.381 276.557 61.438 22.362-11.264 30.946-61.438-22.362z"/>
  <path fill={allFalse ? '#00ca8a'  : category["Sports"] ? "#00ca8a" : "#B0B0B0" }  d="m334.104 307.538 61.439 22.362-.761 2.09-61.438-22.362z"/>

{/* girl cr near canteen */}
  <path fill={allFalse ? '#ff69eb'  : category["Restroom"] ? "#ff69eb" : "#B0B0B0" } d="M115 407h7v6.646h-7z"/>
  <path fill={allFalse ? '#cf56bf'  : category["Restroom"] ? "#cf56bf" : "#B0B0B0" }  d="M115 413.646h7v1.353h-7z"/>
{/* boy cr near canteen */}
  ...
  <path fill="#f7ff5f" d="M185 397h11v12.019h-11z"/>
  <path fill="#cdd34f" d="M185 409.019h11V411h-11z"/>
  <path fill="#f7ff5f" d="M357 447.411h13v10.871h-13z"/>
  <path fill="#cdd34f" d="M357 458.282h13v1.792h-13z"/>

  {/* FITNESS GYM */}
  <path fill={allFalse ? '#00ffae'  : category["Sports"] ? "#00ffae" : "#B0B0B0" } d="M274 397v24h-43v-24z"/>

  <path fill="#f7ff5f" d="M400 425v21.432h-24V425z"/>
  <path fill="#cdd34f" d="M376 446.432h24V448h-24z"/>
  <path fill="#ff3030" d="M274 422v25h-43v-25z"/>
  <path fill="#ff3030" d="M239 448v22h-8v-22z"/>
  <path fill="#ff3030" d="M274 448v22h-34v-22z"/>
  <path fill={allFalse ? '#ff8000'  : category["Laboratory"] ? "#ff8000" : "#B0B0B0" } d="M245 471v15h-14v-15z"/>
  <path fill={allFalse ? '#ff8000'  : category["Laboratory"] ? "#ff8000" : "#B0B0B0" } d="M274 478v17h-16v-17z"/>
  <path fill={allFalse ? '#ff8000'  : category["Laboratory"] ? "#ff8000" : "#B0B0B0" } d="M231 487h15v-16h28v6h-17v19h17v12.082h-43z"/>
  <path fill={allFalse ? '#ce6700'  : category["Laboratory"] ? "#ce6700" : "#B0B0B0" } d="M231 508.082h43V510h-43z"/>
  
  {/* oval */}
  <path fill={allFalse ? '#f55456'  : category["Sports"] ? "#f55456" : "#B0B0B0" } d="m266.337 81.0004 26.655 25.4656L110.655 274.62 84 249.155z"/>
  

  <path fill={allFalse ? '#f55456'  : category["Sports"] ? "#f55456" : "#B0B0B0" } onClick={()=>bldClicked("Oval")} style={{cursor: "pointer"}}  d="M112.914 326.486c-29.7551-28.367-29.4148-73.996.76-101.916l112.718-104.295c30.175-27.9191 78.758-27.5566 108.513.81 29.754 28.367 29.414 73.996-.76 101.916L221.426 327.296c-30.175 27.919-78.757 27.557-108.512-.81"/>
  {/* oval inner green */}
  ...
  {/* PE HALL */}
  <path fill={allFalse ? '#00ffae'  : category["Sports"] ? "#00ffae" : "#B0B0B0" }   d="M287 315v17h-20v-17z"/>
  <path fill={allFalse ? '#00ffae'  : category["Sports"] ? "#00ffae" : "#B0B0B0" }  d="M287 333v16.01h-20V333z"/>
  <path fill={allFalse ? '#00ca8a'  : category["Sports"] ? "#00ca8a" : "#B0B0B0" }  d="M267 349h20v2h-20z"/>
 ...
 {/* General Chemistry Lab path */}
  ...
  <path opacity={path === "New CEAS Room 2" ? "1" : 0 } stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.502 727.276-.001-1.002c-.
  001-1.104-.896-1.998-2-1.998H141.5c-1.105 0-2-.896-2-2V606.274c0-.828-.672-1.5-1.5-1.5"/>
  ...
  {/* Oval path */}
  <path id='grow-path' opacity={path === "Oval" ? "1" : 0 } stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.502 727.283-.001-1.002c-.001-1.104-.896-1.998-2-1.998l-57.001-.001c-1.105 0-2-.895-2-2V541.289c0-1.105.895-2 2-2h5.5c1.105 0 2-.896 2-2v-20.5c0-1.105-.895-2-2-2h-45c-1.105 0-2-.896-2-2V341.501c0-.744.413-1.427 1.072-1.772l9.428-4.938"/>
