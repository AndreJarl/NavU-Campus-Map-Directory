...
const Floor3 = memo(forwardRef(({ viewBox, zooomBuildingbyName, OpenCard }, ref) => {
 ...
 <g  className="floating-element" onClick={() => setCurrentFloor(currentFloor + 1)}  xmlns="http://www.w3.org/2000/svg" filter="url(#filter0_d_2041_14)">
  <circle cx="281" cy="716" r="6" fill="#FF3030"/>
  <text onClick={() => setCurrentFloor(currentFloor + 1)}
    x="281" 
    y="714" 
    fill="white" 
    font-size="2" 
...
>
  ...
  >
   ...
   <g onClick={()=>setCurrentFloor(currentFloor-1)} cursor={"pointer"} className="floating-element" xmlns="http://www.w3.org/2000/svg" filter="url(#filter2_d_2041_14)">
...
<g onClick={()=>setCurrentFloor(currentFloor+1)} cursor={"pointer"} className="floating-element" filter="url(#filter1_d_2041_14)">  
      <circle cx="106" cy="716" r="6" fill="#FF3030" />
      <text onClick={()=>setCurrentFloor(2)} cursor={"pointer"}
        x="106"
        y="714"
        fill="white"
        fontSize="2"
...
<path d="M204.017 726.787V725.82C204.017 725.268 203.569 724.82 203.017 724.82H193.287C192.734 724.82 192.287 724.373 192.287 723.82V719.107C192.287 718.554 191.839 718.107 191.287 718.107H185.067" stroke="#FF0000" stroke-opacity="0.5" stroke-width="1.5" stroke-linecap="round"/>
<path d="M204.04 726.814V725.885C204.04 725.333 204.488 724.885 205.04 724.885H245.247C245.799 724.885 246.247 724.438 246.247 723.885V719.92C246.247 719.368 246.695 718.92 247.247 718.92L256.757 718.92" stroke="#FF0000" stroke-opacity="0.5" stroke-width="1.5" stroke-linecap="round"/>
<path d="M204.025 726.82V725.828C204.025 725.275 203.577 724.828 203.025 724.828H139.916C139.363 724.828 138.916 724.38 138.916 723.828V719.92C138.916 719.368 138.468 718.92 137.916 718.92L128.544 718.92" stroke="#FF0000" stroke-opacity="0.5" stroke-width="1.5" stroke-linecap="round"/>
...
<path d="M247.272 654.894H247.243C246.691 654.894 246.243 655.342 246.243 655.894L246.243 717.92C246.243 718.473 246.691 718.92 247.243 718.92H256.757" stroke="#FF0000" stroke-opacity="0.5" stroke-width="1.5" stroke-linecap="round"/>
<path d="M247.5 640H247.243C246.691 640 246.243 640.448 246.243 641V717.92C246.243 718.472 246.691 718.92 247.243 718.92H256.757" stroke="#FF0000" stroke-opacity="0.5" stroke-width="1.5" stroke-linecap="round"/>
<path d="M247.5 626H247.243C246.691 626 246.243 626.448 246.243 627V717.92C246.243 718.472 246.691 718.92 247.243 718.92H256.757" stroke="#FF0000" stroke-opacity="0.5" stroke-width="1.5" stroke-linecap="round"/>
<path d="M247.5 614H247.243C246.691 614 246.243 614.448 246.243 615V717.92C246.243 718.472 246.691 718.92 247.243 718.92H256.757" stroke="#FF0000" stroke-opacity="0.5" stroke-width="1.5" stroke-linecap="round"/>
<path d="M247.5 601H247.243C246.691 601 246.243 601.448 246.243 602V717.92C246.243 718.472 246.691 718.92 247.243 718.92H256.757" stroke="#FF0000" stroke-opacity="0.5" stroke-width="1.5" stroke-linecap="round"/>
<path d="M247.5 588H247.243C246.691 588 246.243 588.448 246.243 589V717.92C246.243 718.472 246.691 718.92 247.243 718.92H256.757" stroke="#FF0000" stroke-opacity="0.5" stroke-width="1.5" stroke-linecap="round"/>
<path d="M247.5 575.5H247.243C246.691 575.5 246.243 575.948 246.243 576.5V717.92C246.243 718.472 246.691 718.92 247.243 718.92H256.757" stroke="#FF0000" stroke-opacity="0.5" stroke-width="1.5" stroke-linecap="round"/>
<path d="M247.5 564H247.243C246.691 564 246.243 564.448 246.243 565L246.243 717.92C246.243 718.472 246.691 718.92 247.243 718.92H256.757" stroke="#FF0000" stroke-opacity="0.5" stroke-width="1.5" stroke-linecap="round"/>
...
<path d="M247.369 690.635L247.243 690.635C246.691 690.635 246.243 691.083 246.243 691.635V717.92C246.243 718.473 246.691 718.92 247.243 718.92H256.757" stroke="#FF0000" stroke-opacity="0.5" stroke-width="1.5" stroke-linecap="round"/>
