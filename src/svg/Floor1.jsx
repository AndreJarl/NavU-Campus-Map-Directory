...
const Floor1 = memo(forwardRef(({ viewBox, zooomBuildingbyName, OpenCard }, ref) => {
  ...
  return (
    ...
    >
        ...
        <path opacity={path === "g" ? "1" : 0} stroke="red" id="grow-path" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164V726.351C200.568 725.246 201.464 724.351 202.568 724.351H243.539C244.643 724.351 245.539 723.456 245.539 722.351V541.278C245.539 540.173 244.643 539.278 243.539 539.278H237.5C236.395 539.278 235.5 538.382 235.5 537.278V517.776C235.5 516.671 234.605 515.776 233.5 515.776H194.59C194.038 515.776 193.59 515.328 193.59 514.776V496.75C193.59 496.197 193.143 495.75 192.59 495.75H188.461C187.908 495.75 187.461 496.197 187.461 496.75V498.517" />
        <path opacity={path === "g" ? "1" : 0} stroke="red" id="grow-path" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.502 727.273L200.501 726.271C200.5 725.167 199.605 724.273 198.501 724.273H141.5C140.395 724.273 139.5 723.377 139.5 722.273V657.759C139.5 656.654 138.605 655.759 137.5 655.759H95C93.8955 655.759 93 654.863 93 653.759V625.335C93 624.962 92.8956 624.597 92.6986 624.28L81.8014 606.749C81.6044 606.432 81.5 606.067 81.5 605.694V560.527C81.5 559.975 81.0523 559.527 80.5 559.527L63.4109 559.527C62.8587 559.527 62.411 559.975 62.411 560.527V563.372C62.411 563.924 62.8587 564.372 63.411 564.372H67.1088"/>
        <path opacity={
