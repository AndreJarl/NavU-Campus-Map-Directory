  ...
  return (
    <>
      ...
      >
        ...
        <rect xmlns="http://www.w3.org/2000/svg" x="136" y="562" width="16" height="21" transform="rotate(90 136 562)" fill="#00c3ff" stroke="#4391A9" stroke-width={0.4} />
        ...
        <path fill="#ff6453" stroke="#B84336" stroke-width={0.4} d="M126 723h8v5h8v21.085h-16z" />
        <text x="134" y="738.61" text-anchor="middle" font-weight="600" font-family="Inter, sans-serif" font-size="2" fill="black">ACCOUNTING</text>
        <text x="134" y="741.41" text-anchor="middle" font-weight="600" font-family="Inter, sans-serif" font-size="2" fill="black">OFFICE</text>
        <path fill="#ce4b46" stroke="#B84336" stroke-width={0.4} d="M126 749.085h16V751h-16z" />
        ...
        <path fill="#ff69eb" stroke="#D74DC9" stroke-width={0.4} d="M272 528v15h-9v-15z" />

        {/* COE Room 2 bldg */}
        <path fill="#ff3030" stroke="#C32525" stroke-width={0.4} d="M249 544h21v17h-21z" />
        <text x="259.5" y="553.5" text-anchor="middle" font-weight="600" font-family="Inter, sans-serif" font-size="2" fill="black">ROOM 2</text>

        {/* COE Room 1 bldg */}
        <path fill="#ff3030" stroke="#C32525" stroke-width={0.4} d="M270 562v16h-21v-16z" />
        ...
        {/* Ergonomic Lab bldg */}
        <path fill="#ff8000" stroke="#D76C00" stroke-width={0.4} d="M205 540h22v21h-22z" />
        ...
        <path fill="#ff8000" stroke="#D76C00" stroke-width={0.4} d="M227 584v21h-22v-21z" />
        ...
        {/* EDTECH Lab 2 bldg */}
        <path fill="#ff8000" stroke="#D76C00" stroke-width={0.4} d="M227 606v21h-22v-21z" />
        ...
        {/* New CEAS CR bldg */}
        <path fill="#ff69eb" stroke="#D74DC9" stroke-width={0.4} d="M113 528v15h9v-15z" />

        {/* New CEAS Room 5 bldg */}
        <path fill="#00c3ff" stroke="#4391A9" stroke-width={0.4} d="M115 544h21v17h-21z" />
        ...
        {/*  */}
        <path fill="#0080ff" d="m25.5078 522.63 17.3889326.63436844-1.55969218 42.75335977-17.3889326-.63436844z" />

        {/* New CEAS Room 3 bldg */}
        <path fill="#00c3ff" stroke="#4391A9" stroke-width={0.4} d="M136 579v17h-21v-17z" />
        ...
        {/* Quadrangle bldg */}
        <path fill="#00ffae" stroke="#01CC8C" stroke-width={0.4} d="M195 589v51.391h-40V589z" />
        ...
        <path fill="#01db96" stroke="#01CC8C" stroke-width={0.4} d="M155 640.261h40V643h-40z" />

        {/* Flag pole bldg */}
        <path fill="#00ffae" stroke="#01CC8C" stroke-width={0.4} d="M202 700v10.468h-18V700z" />
        <text x="193" y="705.6" text-anchor="middle" font-weight="600" font-family="Inter, sans-serif" font-size="2" fill="black">FLAG POLE</text>
        <path fill="#01db96" stroke="#01CC8C" stroke-width={0.4} d="M184 709.721h18V711h-18z" />

        {/* New CEAS Room 2 bldg */}
        <path fill="#00c3ff" stroke="#4391A9" stroke-width={0.4} d="M136 597v16h-21v-16z" />
        ...
        <path fill="#ff8000" stroke="#D76C00" stroke-width={0.4} d="M62.457 486.005V494h-11l5.8236-7.995z" />

        {/* Production Area bldg */}
        <path fill="#ff8000" stroke="#D76C00" stroke-width={0.4} d="M78 495v14H47v-7.881l2.4404-3.846L50.8946 495z" />

        {/* Production Office bldg */}
        <path fill="#ff8000" stroke="#D76C00" stroke-width={0.4} d="M78 510v11H62v-11z" />

        {/* Production Area Stock Room 1 bldg */}
        <path fill="#ff8000" stroke="#D76C00" stroke-width={0.4} d="M61 510v11H47v-11z" />

        {/* Extension & Production Office bldg */}
        <path fill="#ff8000" stroke="#D76C00" stroke-width={0.4} d="M78 522v7H47v-7z" />

        {/* Supply Office bldg */}
        <path fill="#ff8000" stroke="#D76C00" stroke-width={0.4} d="M78 530v12H62v-12z" />

        {/* Old Admin Storage Room bldg */}
        <path fill="#ff8000" stroke="#D76C00" stroke-width={0.4} d="M78 543v13H47v-26h13.9843v13z" />

        <path fill="#fc0" d="M59 557v10H47v-10z" />
        <path fill="#fc0" d="M59 568v7H47v-7z" />
        <path fill="#fc0" d="M59 576v6H47v-6z" />
        <path fill="#fc0" d="M59 583v6H47v-6z" />
        <path fill="#fc0" d="M59 590v7H47v-7z" />
        <path fill="#fc0" d="M78 568v17H60v-17z" />
        ...
        {/* Sewing Lab bldg */}
        <path fill="#ff8000" stroke="#D76C00" stroke-width={0.4} d="m41.3387 567.29-.7631 20.919-17.389-.635.7631-20.919z" />
        <path fill="#ce6700" stroke="#D76C00" stroke-width={0.4} d="m23.22 586.659 17.3889.634-.0715 1.962-17.389-.635z" />

        {/* New CEAS Room 1 bldg */}
        <path fill="#00c3ff" stroke="#4391A9" stroke-width={0.4} d="M136 614v30.564h-21V614z" />
        ...
        <path onClick={() => bldClicked("Civil Engineering Lab 1")} style={{ cursor: "pointer" }} fill="#ff3030" stroke="#C32525" stroke-width={0.4} d="M270 664v17h-21v-17z" />
        ...
        <path fill={allFalse ? '#ff69eb' : category["Restroom"] ? "#ff69eb" : "#B0B0B0"} stroke="#D74DC9" stroke-width={0.4} d="M249 699h24v8.938h-24z" />
        ...
        <path fill={allFalse ? '#cf56bf' : category["Restroom"] ? "#cf56bf" : "#B0B0B0"} stroke="#D74DC9" stroke-width={0.4} d="M249 707.938h24V710h-24z" />

        {/* woman cr near accounting */}

        <path fill={allFalse ? '#ff69eb' : category["Restroom"] ? "#ff69eb" : "#B0B0B0"} stroke="#D74DC9" stroke-width={0.4} d="M112 699h24v8.937h-24z" />
        ...
        <path fill={allFalse ? '#cf56bf' : category["Restroom"] ? "#cf56bf" : "#B0B0B0"} stroke="#D74DC9" stroke-width={0.4} d="M112 707.937h24V710h-24z" />

        {/* MIS Office bldg */}
        <path fill="#ff6453" stroke="#B84336" stroke-width={0.4} d="M143 728h15v21.021h-15z" />
        <text x="150.5" y="738.61" text-anchor="middle" font-weight="600" font-family="Inter, sans-serif" font-size="2" fill="black">MIS</text>
        <text x="150.5" y="741.41" text-anchor="middle" font-weight="600" font-family="Inter, sans-serif" font-size="2" fill="black">OFFICE</text>
        <path fill="#ce4b46" stroke="#B84336" stroke-width={0.4} d="M143 749.021h15V751h-15z" />

        {/* Registrar bldg */}
        <path fill="#ff6453" stroke="#B84336" stroke-width={0.4} d="M159 728h15v21.021h-15z" />
        <text x="166.5" y="739.7" text-anchor="middle" font-weight="600" font-family="Inter, sans-serif" font-size="2" fill="black">REGISTRAR</text>
        <path fill="#ce4b46" stroke="#B84336" stroke-width={0.4} d="M159 749.021h15V751h-15z" />

        {/* Power House bldg */}
        <path fill="#ff6453" stroke="#B84336" stroke-width={0.4} d="M261 730h15v18.279h-15z" />
        <text x="268.5" y="739.24" text-anchor="middle" font-weight="600" font-family="Inter, sans-serif" font-size="2" fill="black">POWER</text>
        <text x="268.5" y="742.04" text-anchor="middle" font-weight="600" font-family="Inter, sans-serif" font-size="2" fill="black">HOUSE</text>
        <path fill="#ce4b46" stroke="#B84336" stroke-width={0.4} d="M261 748.279h15V750h-15z" />

        {/* Cashier bldg */}
        <path fill="#ff6453" stroke="#B84336" stroke-width={0.4} d="M211 728h16v21.021h-16z" />
        <text x="219" y="739.7" text-anchor="middle" font-weight="600" font-family="Inter, sans-serif" font-size="2" fill="black">CASHIER</text>
        <path fill="#ce4b46" stroke="#B84336" stroke-width={0.4} d="M211 749.021h16V751h-16z" />

        {/* BAC bldg */}
        <path fill="#ff6453" stroke="#B84336" stroke-width={0.4} d="M228 728h15v21.021h-15z" />
        <text x="235.5" y="738.61" text-anchor="middle" font-weight="600" font-family="Inter, sans-serif" font-size="2" fill="black">BAC</text>
        <text x="235.5" y="741.41" text-anchor="middle" font-weight="600" font-family="Inter, sans-serif" font-size="2" fill="black">OFFICE</text>
        <path fill="#ce4b46" stroke="#B84336" stroke-width={0.4} d="M228 749.021h15V751h-15z" />

        <path fill="#ff4c85" d="M152 542h9v-5h13.596v5.372h22.198v14.709H152z" />
        <path fill="#d94272" d="M152 556.953h44.794V559H152z" />

        {/* Clinic bldg */}
        <path fill="#ff6453" stroke="#B84336" stroke-width={0.4} d="M244 728h8v-5h8v26.066h-16z" />
        <text x="252" y="739.7" text-anchor="middle" font-weight="600" font-family="Inter, sans-serif" font-size="2" fill="black">CLINIC</text>
        <path fill="#ce4b46" stroke="#B84336" stroke-width={0.4} d="M244 749.066h16V751h-16z" />

        <path fill="#ff4c85" d="M108 421h39v46h-39z" />

        {/* Canteen Stock Room bldg */}
        <path fill="#ff4c85" d="M132 468h14.956v7.283H132z" />
        <path fill="#d94272" d="M132 475.283h14.956v1.69H132z" />

        <path fill="#fc0" d="M131 468v17h-23v-17z" />
        <path fill="#fc0" d="M108 486h24v16h-24z" />
        <path fill="#d6b018" d="M108 502h24v2h-24z" />
        <path fill="#0080ff" d="M359 462.486h19v33.189h-19z" />
        <path fill="#006cd7" d="M359 495.409h19v2.655h-19z" />
        <path fill="#fc0" d="M167 353h68v16h-68z" />
        <path fill="#d6b018" d="M167 369h68v2h-68z" />

        {/* Grandstand bldg */}
        <path fill="#00c3ff" stroke="#4391A9" stroke-width={0.4} d="m91.6124 179.949 2.7928-2.568 5.3134 5.778 5.3934-4.959-5.3137-5.779 2.8887-2.656 5.314 5.778 5.393-4.959-5.314-5.778 2.89-2.657 5.313 5.778 5.393-4.959-5.313-5.778 2.889-2.657 5.313 5.778 5.393-4.959-5.313-5.778 2.889-2.657 5.313 5.778 5.393-4.959-5.313-5.778 2.889-2.657 5.313 5.779 5.394-4.96-5.314-5.778 2.889-2.657 5.314 5.779 5.393-4.959-5.314-5.779 2.889-2.656 5.314 5.778 5.393-4.959-5.313-5.779 2.889-2.656 5.313 5.778 5.393-4.959-5.313-5.778 2.889-2.657 5.313 5.778 5.393-4.959-5.313-5.778 2.889-2.657L182.54 107l5.393-4.959-5.313-5.7781 2.889-2.6567 5.314 5.7782 5.393-4.9591-5.314-5.7783 2.889-2.6567 22.41 24.3707-102.179 93.958z" />
        <path fill="#0094cf" stroke="#4391A9" stroke-width={0.4} d="m114.017 204.314 102.179-93.959 2.125 2.312-102.178 93.958z" />

        <path fill="#fc0" d="M155 397h23v25h-23z" />
        <path fill="#fc0" d="M178 423v17h-23v-17z" />
        <path fill="#fc0" d="M178 441v17h-23v-17z" />
        <path fill="#fc0" d="M178 459v17h-23v-17z" />
        <path fill="#fc0" d="M155 477h23v25.034h-23z" />
        <path fill="#d6b018" d="M155 502.034h23V504h-23z" />
        <path fill="#7bff00" d="M213 525h19v9.875h-19z" />
        <path fill="#64cf00" d="M213 534.75h19V536h-19z" />
        ...
        <path fill="#fc0" d="M133 486h10v16h-10z" />
        <path fill="#d6b018" d="M133 502h10v2h-10z" />
        <path fill="#fc0" d="M144 486h9.955v16H144z" />
        <path fill="#d6b018" d="M144 502h9.955v2H144z" />
        <path fill="#fc0" d="M203 397h23v25h-23z" />
        <path fill="#fc0" d="M226 422.999v16.9412h-23V422.999z" />
        <path fill="#fc0" d="M226 441v17h-23v-17z" />
        <path fill="#fc0" d="M226 459v17h-23v-17z" />
        <path fill="#fc0" d="M225.997 477v25.427H203V477z" />
        ...
        <path fill="#01db96" stroke="#01CC8C" stroke-width={0.4} d="M294 506.926h29V510h-29z" />

        {/* ???? bldg */}
        <path fill="#00ffae" stroke="#01CC8C" stroke-width={0.4} d="M356 431v21h-23v-21z" />

        {/*  */}
        <path fill="#f7ff5f" stroke="#CBD14E" stroke-width={0.4} d="M356 453v21h-23v-21z" />

        {/* Kitchen Lab bldg */}
        <path fill="#ff8000" stroke="#D76C00" stroke-width={0.4} d="m355.997 475 .003 32.451h-22.997L333 475z" />
        <path fill="#ce6700" stroke="#D76C00" stroke-width={0.4} d="M333.003 507.451H356V510h-22.997z" />

        {/* Carpentry shop bldg */}
        <path fill="#f7ff5f" stroke="#CBD14E" stroke-width={0.4} d="m445.004 467.866-10.419 30.553-21.67-7.389 10.419-30.554z" />
        <path fill="#D1D851" stroke="#CBD14E" stroke-width={0.4} d="m413.079 490.558 21.67 7.39-.805 2.362-21.671-7.389z" />

        {/* Tennis Court bldg */}
        <path fill="#00ffae" stroke="#01CC8C" stroke-width={0.4} d="M326.039 387.31h70.959v32.582h-70.959z" />
        ...
        <path fill="#f7ff5f" stroke="#CBD14E" stroke-width={0.4} d="M357 447.411h13v10.871h-13z" />
        ...
        <path fill="#ff8000" stroke="#D76C00" stroke-width={0.4} d="M245 471v15h-14v-15z" />

        {/* Fablab Office bldg */}
        <path fill="#ff8000" stroke="#D76C00" stroke-width={0.4} d="M274 478v17h-16v-17z" />

        {/* Fablab Production Area */}
        <path fill="#ff8000" stroke="#D76C00" stroke-width={0.4} d="M231 487h15v-16h28v6h-17v19h17v12.082h-43z" />
        <path fill="#ce6700" stroke="#D76C00" stroke-width={0.4} d="M231 508.082h43V510h-43z" />

        <path fill="#f55456" d="m266.337 81.0004 26.655 25.4656L110.655 274.62 84 249.155z" />
        <path fill="#f55456" d="M112.914 326.486c-29.7551-28.367-29.4148-73.996.76-101.916l112.718-104.295c30.175-27.9191 78.758-27.5566 108.513.81 29.754 28.367 29.414 73.996-.76 101.916L221.426 327.296c-30.175 27.919-78.757 27.557-108.512-.81" />
        <path fill="#51ff7d" d="M125.471 315.626c-22.941-21.872-22.679-57.053.586-78.579l112.5-104.093c23.266-21.526 60.724-21.247 83.665.625 22.942 21.871 22.68 57.052-.586 78.579l-112.5 104.092c-23.265 21.527-60.723 21.247-83.665-.624" />
        
        {/* Sports & Athletics Office bldg */}
        <path fill="#00ffae" stroke="#01CC8C" stroke-width={0.4} d="M287 315v17h-20v-17z" />

        {/* Socio-Cultural Office bldg */}
        <path fill="#00ffae" stroke="#01CC8C" stroke-width={0.4} d="M287 333v16.01h-20V333z" />
        <path fill="#01db96" stroke="#01CC8C" stroke-width={0.4} d="M267 349h20v2h-20z" />

        {/*  */}
        <path fill="#8649ff" d="M36 748h18v5.906H36z" />
        <path fill="#6f3dd2" d="M36 753.687h18V755H36z" />
        <path fill="#8649ff" d="M36 701h18v5.906H36z" />
        <path fill="#6f3dd2" d="M36 706.687h18V708H36z" />
        <path fill="#8649ff" d="M12 742h23v10.969H12z" />
        <path fill="#6f3dd2" d="M12 752.969h23V755H12z" />
        <path fill="#8649ff" d="M35 701v26H12v-26z" />
        <path fill="#8649ff" d="M35 728v13H12v-13z" />
        <circle cx="64" cy="728" r="7" fill="#5aeeff" />
        <ellipse cx="427" cy="701" fill="#19e0ff" rx="19" ry="10" />
        ...
        <path opacity={path === " COE Computer Laboratory 2" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.158v-.813c0-1.105.896-2 2-2h40.971c1.104 0 2-.895 2-2v-116.11c0-.806.653-1.46 1.459-1.46" />

        {/* COE Electrical Laboratory path */}
        <path opacity={path === "COE Electrical Laboratory" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.158v-.814c0-1.104.896-1.999 2-1.999h40.971c1.104 0 2-.896 2-2V588.236c0-.807.654-1.462 1.461-1.463" />

        {/* COE Room 1 path */}
        <path opacity={path === "COE Room 1" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.158v-.813c0-1.105.896-2 2-2h40.971c1.104 0 2-.896 2-2v-151.11c0-.806.654-1.461 1.461-1.461" />

        {/* COE Room 2 path */}
        <path opacity={path === "COE Room 2" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.165v-.813c0-1.105.896-2 2-2h40.971c1.104 0 2-.896 2-2v-168.11c0-.807.654-1.462 1.461-1.463" />

        {/* CME CR path */}
        <path opacity={path === "CME CR" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.104.896-1.999 2-1.999h40.971c1.104 0 2-.896 2-2V544.279c0-1.104.895-2 2-2H260" />

        {/* Study area path */}
        <path opacity={path === "Study area" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.104.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.278c0-1.105-.896-2-2-2H232.5c-.828 0-1.5-.672-1.5-1.5" />

        {/* FABLAB Production Area path */}
        <path opacity={path === "FABLAB Production Area" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.105.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.278c0-1.105-.896-2-2-2H237.5c-1.105 0-2-.896-2-2v-19.502c0-1.105.895-2 2-2H258c1.105 0 2-.896 2-2v-2" />

        {/* Woodcarving Area path */}
        <path opacity={path === "Woodcarving Area" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.105.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.278c0-1.105-.896-2-2-2H237.5c-1.105 0-2-.896-2-2v-19.502c0-1.105-.895-2-2-2h-3c-1.105 0-2-.895-2-2v-32.233c0-.276.224-.5.5-.5" />

        {/* Maintenance Office path */}
        <path opacity={path === "Maintenance Office" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.104.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.278c0-1.105-.896-2-2-2H237.5c-1.104 0-2-.896-2-2v-19.502c0-1.104-.895-2-2-2h-3c-1.104 0-2-.895-2-2v-49.485c0-.276.224-.5.5-.5" />

        {/* COT Room 26 path */}
        <path opacity={path === "COT Room 26" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.105.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.278c0-1.105-.896-2-2-2H237.5c-1.105 0-2-.896-2-2v-19.502c0-1.105-.895-2-2-2l-17-.001c-1.105 0-2-.895-2-2v-8.006" />

        {/* Automation Laboratory path */}
        <path opacity={path === "Automation Laboratory" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.105.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.278c0-1.105-.896-2-2-2H237.5c-1.105 0-2-.896-2-2v-19.502c0-1.105-.895-2-2-2h-70c-1.105 0-2-.896-2-2v-8.017" />

        {/* GAD Office path */}
        <path opacity={path === "GAD Office" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.105.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.278c0-1.105-.896-2-2-2H237.5c-1.105 0-2-.896-2-2v-19.502c0-1.105-.895-2-2-2h-70c-1.105 0-2-.896-2-2v-5.009c0-1.104-.895-2-2-2H150c-.552 0-1-.447-1-1" />

        {/* NSTP Office path */}
        <path opacity={path === "NSTP Office" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.105.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.278c0-1.105-.896-2-2-2H237.5c-1.105 0-2-.896-2-2v-19.502c0-1.105-.895-2-2-2h-70c-1.105 0-2-.896-2-2v-5.009c0-1.104-.895-2-2-2H139c-.552 0-1-.447-1-.999" />

        {/* COT Computer Laboratory path */}
        <path opacity={path === "COT Computer Laboratory" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.104.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.278c0-1.105-.896-2-2-2H237.5c-1.105 0-2-.896-2-2v-19.502c0-1.105-.895-2-2-2h-70c-1.105 0-2-.896-2-2v-5.009c0-1.104-.895-2-2-2h-38.499c-.553 0-1.001-.447-1.001-1" />

        {/* COT Room 41 path */}
        <path opacity={path === "COT Room 41" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.105.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.278c0-1.105-.896-2-2-2H237.5c-1.105 0-2-.896-2-2v-19.502c0-1.105-.895-2-2-2h-41c-1.105 0-2-.896-2-2v-5.017c0-1.104-.895-2-2-2h-6c-1.105 0-2-.895-2-2v-33.992c0-.276-.224-.5-.5-.5" />

        {/* COT Room 40 path */}
        <path opacity={path === "COT Room 40" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.104.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.278c0-1.105-.896-2-2-2H237.5c-1.105 0-2-.896-2-2v-19.502c0-1.104-.895-2-2-2h-41c-1.105 0-2-.895-2-2v-5.017c0-1.104-.895-2-2-2l-6 .001c-1.105 0-2-.896-2-2v-54.493c0-.276-.224-.5-.5-.5" />

        {/* COT Room 39 path  */}
        <path opacity={path === "COT Room 39" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.104.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.278c0-1.105-.896-2-2-2H237.5c-1.105 0-2-.896-2-2v-19.502c0-1.105-.895-2-2-2h-41c-1.105 0-2-.896-2-2v-5.017c0-1.104-.895-2-2-2h-6c-1.105 0-2-.895-2-2v-72.495c0-.276-.224-.5-.5-.5" />

        {/* COT Room 38 path */}
        <path opacity={path === "COT Room 38" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.104.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.278c0-1.105-.896-2-2-2H237.5c-1.105 0-2-.896-2-2v-19.502c0-1.104-.895-2-2-2h-41c-1.105 0-2-.895-2-2v-5.017c0-1.104-.895-2-2-2l-6 .001c-1.105 0-2-.896-2-2v-91.493c0-.276-.224-.5-.5-.5" />

        {/* COT Room 34 path */}
        <path opacity={path === "COT Room 34" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.105.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.278c0-1.105-.896-2-2-2H237.5c-1.105 0-2-.896-2-2v-19.502c0-1.105-.895-2-2-2l-17-.001c-1.105 0-2-.895-2-2v-5.006c0-1.105-.895-2-2-2H203c-1.105 0-2-.896-2-2v-34.005c0-.276.224-.5.5-.5" />

        {/* COT Room 35 path */}
        <path opacity={path === "COT Room 35" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.104.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.278c0-1.105-.896-2-2-2H237.5c-1.105 0-2-.896-2-2v-19.502c0-1.105-.895-2-2-2h-17c-1.105-.001-2-.896-2-2v-5.007c0-1.105-.895-2-2-2H203c-1.105 0-2-.895-2-2v-54.508c0-.276.224-.5.5-.5" />

        {/* COT Room 36 path */}
        <path opacity={path === "COT Room 36" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.104.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.278c0-1.105-.896-2-2-2H237.5c-1.105 0-2-.896-2-2v-19.502c0-1.105-.895-2-2-2h-17c-1.105-.001-2-.896-2-2v-5.007c0-1.105-.895-2-2-2H203c-1.105 0-2-.895-2-2V432.26c0-.276.224-.5.5-.5" />

        {/* COT Room 37 path */}
        <path opacity={path === "COT Room 37" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.104.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.278c0-1.105-.896-2-2-2H237.5c-1.105 0-2-.896-2-2v-19.502c0-1.104-.895-2-2-2h-17c-1.105 0-2-.896-2-2v-5.007c0-1.105-.895-2-2-2H203c-1.105 0-2-.895-2-2v-91.51c0-.276.224-.5.5-.5" />

        {/* Sanitation Staff Office path */}
        <path opacity={path === "Sanitation Staff Office" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.104.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.278c0-1.105-.896-2-2-2H237.5c-1.105 0-2-.896-2-2v-19.502c0-1.104-.895-2-2-2h-17c-1.105 0-2-.896-2-2v-5.007c0-1.105-.895-2-2-2H203c-1.105 0-2-.895-2-2v-96.978c0-1.105-.895-2-2-2h-1" />

        {/* Floating Room path */}
        <path opacity={path === "Floating Room" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.104.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.278c0-1.105-.896-2-2-2H237.5c-1.104 0-2-.896-2-2v-19.502c0-1.104-.895-2-2-2h-17c-1.105 0-2-.896-2-2v-5.007c0-1.105-.895-2-2-2H203c-1.104 0-2-.895-2-2V372.791" />

        {/* SAC path */}
        <path opacity={path === "Floating Room" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.105.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.278c0-1.105-.896-2-2-2H237.5c-1.105 0-2-.896-2-2v-19.502c0-1.105.895-2 2-2H307c1.105 0 2-.895 2-2v-2.003" />

        {/* Carpentry Shop path */}
        <path opacity={path === "Carpentry Shop" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.105.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.278c0-1.105-.896-2-2-2H237.5c-1.105 0-2-.896-2-2v-19.502c0-1.105.895-2 2-2h131.281c.465 0 .915-.162 1.273-.458l38.892-32.09c.358-.296.808-.457 1.273-.457h3.281" />

        {/* Kitchen Lab path */}
        <path opacity={path === "Kitchen Lab" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.105.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.278c0-1.105-.896-2-2-2H237.5c-1.105 0-2-.896-2-2v-19.502c0-1.105.895-2 2-2H318c1.105 0 2-.898 2-2.002 0-1.105.895-2.002 2-2.002h2c1.105 0 2-.895 2-2v-4c0-1.105.895-2 2-2h3" />

        {/* Electrical Maintenance Office path */}
        <path opacity={path === "Electrical Maintenance Office" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.105.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.278c0-1.105-.896-2-2-2H237.5c-1.105 0-2-.896-2-2v-19.502c0-1.105.895-2 2-2H318c1.105 0 2-.898 2-2.002 0-1.105.895-2.002 2-2.002h2c1.105 0 2-.896 2-2v-38c0-1.105.895-2 2-2h3" />

        {/* ????? path */}
        <path opacity={path === "?????" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.105.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.278c0-1.105-.896-2-2-2H237.5c-1.105 0-2-.896-2-2v-19.502c0-1.105.895-2 2-2H318c1.105 0 2-.898 2-2.002 0-1.105.895-2.002 2-2.002h2c1.105 0 2-.895 2-2v-60.999c0-1.105.895-2 1.999-2l3.001-.001" />

        {/* Electrical Shop path */}
        <path opacity={path === "Electrical Shop" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.105.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.278c0-1.105-.896-2-2-2H237.5c-1.105 0-2-.896-2-2v-19.502c0-1.105.895-2 2-2H318c1.105 0 2-.897 2-2.002s.895-2.002 2-2.002h2c1.105 0 2-.895 2-2v-81.501c0-1.105.895-2 2-2h43" />

        {/* Men's Dorm path */}
        <path opacity={path === "Men's Dorm" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.105.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.278c0-1.105-.896-2-2-2H237.5c-1.105 0-2-.896-2-2v-19.502c0-1.105.895-2 2-2H318c1.105 0 2-.897 2-2.002s.895-2.002 2-2.002h2c1.105 0 2-.895 2-2v-81.501c0-1.105.895-2 2-2h28c1.105 0 2 .895 2 2v14.52c0 1.104.895 2 2 2h11c1.105 0 2 .895 2 2v14" />

        {/* ME Lab 2 path */}
        <path opacity={path === "ME Lab 2" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.814c0-1.104.896-1.999 2-1.999h40.971c1.104 0 2-.896 2-2V541.277c0-1.104-.896-2-2-2H237.5c-1.105 0-2-.895-2-2v-19.501c0-1.105.895-2 2-2H275c1.105 0 2-.896 2-2v-53c0-.552-.448-1-1-1" />

        {/* ME Lab 1 path */}
        <path opacity={path === "ME Lab 1" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.105.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.278c0-1.105-.896-2-2-2H237.5c-1.105 0-2-.896-2-2v-19.502c0-1.105.895-2 2-2H275c1.105 0 2-.895 2-2v-76.999c0-.553-.448-1-1-1" />

        {/* Fitness Gym path */}
        <path opacity={path === "Fitness Gym" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.104.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.278c0-1.105-.896-2-2-2H237.5c-1.105 0-2-.895-2-2v-19.502c0-1.104.895-2 2-2H275c1.105 0 2-.895 2-2V406.777c0-.553-.448-1-1-1" />

        {/* Socio-Cultural Office path */}
        <path opacity={path === "Socio-Cultural Office" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.105.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.278c0-1.105-.896-2-2-2H237.5c-1.105 0-2-.896-2-2v-19.502c0-1.105.895-2 2-2H275c1.104 0 2-.896 2-2v-106c0-1.104.895-2 2-2h10c1.105 0 2-.895 2-2v-57.003c0-1.104-.896-1.999-2-1.999" />

        {/* Sports & Athletics Office path */}
        <path opacity={path === "Sports & Athletics Office" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.163v-.813c0-1.104.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.277c0-1.105-.896-2-2-2H237.5c-1.105 0-2-.896-2-2v-19.502c0-1.105.895-2 2-2H275c1.104 0 2-.895 2-2v-106c0-1.104.895-2 2-2h10c1.105 0 2-.895 2-2v-83.003c0-1.104-.895-1.999-2-2" />

        {/* Kadasig Gym path */}
        <path opacity={path === "Kadasig Gym" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.163v-.813c0-1.105.896-2 2-2h40.971c1.104 0 2-.895 2-2V541.277c0-1.105-.896-2-2-2H237.5c-1.105 0-2-.896-2-2v-19.502c0-1.105.895-2 2-2H275c1.105 0 2-.896 2-2v-106c0-1.104.895-2 2-2h10.798c.74 0 1.419-.408 1.766-1.061l28.702-54.001c.154-.289.234-.611.234-.938v-45.001c0-1.105.895-2 2-2l9.5-.001" />

        {/* Tennis Court path */}
        <path opacity={path === "Tennis Court" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.165v-.814c0-1.104.896-1.999 2-1.999h40.971c1.104 0 2-.896 2-2V541.278c0-1.104-.896-2-2-2H237.5c-1.105 0-2-.895-2-2v-19.502c0-1.104.895-2 2-2H275c1.105 0 2-.895 2-2V407.777c0-1.105.895-2 2-2h16.383c.402 0 .795-.121 1.127-.348l20.98-14.306c.332-.226.725-.347 1.127-.347H324" />

        {/* Ergonomic Lab path */}
        <path opacity={path === "Ergonomic Lab" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.104.896-2 2-2h40.971c1.104 0 2-.895 2-2V539.777c0-1.105-.896-2-2-2H202.5c-1.105 0-2 .896-2 2v6.001c0 1.104.895 2 2 2h.5" />

        {/* BISTRO path */}
        <path opacity={path === "BISTRO" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.568 727.164v-.813c0-1.104.896-1.999 2-1.999h40.971c1.104 0 2-.896 2-2V539.777c0-1.105-.896-2-2-2H202.5c-1.105 0-2 .896-2 2v21.001c0 1.105-.895 2-2 2h-14c-1.105 0-2-.895-2-2" />
        ...
        {/* EDTECH Lab 2 path */}
        <path opacity={path === "EDTECH Lab 2" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.503 727.276-.001-.999c-.001-1.105.895-2.002 2-2.002h40.999c1.104 0 2-.895 2-2v-65.002c0-1.105-.896-2-2-2H202.5c-1.105 0-2-.895-2-2V622.77c0-1.104.895-2 2-2h.5" />

        {/* General Chemistry Lab path */}
        <path opacity={path === "General Chemistry Lab" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.503 727.276-.001-.998c-.001-1.106.895-2.002 2-2.002h40.999c1.104 0 2-.896 2-2v-65.003c0-1.104-.896-2-2-2H202.5c-1.105 0-2-.895-2-2V598.77c0-1.105.895-2 2-2h.5" />
        ...
        {/* cashier path */}
        <path opacity={path === "Cashier" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.502 727.276-.001-.998c-.001-1.106.895-2.002 2-2.002h15c.827 0 1.497.67 1.497 1.497" />

        {/* Registrar path */}
        <path opacity={path === "Registrar" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.502 727.276-.001-1.002c-.001-1.104-.896-1.998-2-1.998h-30.503c-.827 0-1.498.67-1.498 1.498" />

        {/* ERRC Storage path */}
        <path opacity={path === "ERRC Storage" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.5 735.291v1.207c0 1.105-.895 2-2 2H196c-1.104 0-2 .896-2 2v25.793c0 1.104-.895 2-2 2h-86c-1.105 0-2-.896-2-2v-19.5c0-1.105-.895-2-2-2H39.0002c-.5524 0-1.0002.448-1.0002 1" />

        {/* ERRC Room 1 path */}
        <path opacity={path === "ERRC Room 1" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.5 735.291v1.207c0 1.105-.895 2-2 2H196c-1.104 0-2 .896-2 2v25.793c0 1.104-.895 2-2 2h-86c-1.105 0-2-.896-2-2v-19.5c0-1.105-.895-2-2-2H37" />

        {/* ERRC Room 2 path */}
        <path opacity={path === "ERRC Room 2" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.5 735.29v1.208c0 1.105-.895 2-2 2H196c-1.104 0-2 .895-2 2v25.792c0 1.105-.895 2-2 2h-86c-1.105 0-2-.895-2-2v-26.499c0-1.105-.895-2-2-2H37" />

        {/* ERRC Office path */}
        <path opacity={path === "ERRC Office" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.5 735.29v1.208c0 1.104-.895 2-2 2H196c-1.104 0-2 .895-2 2v25.792c0 1.105-.895 2-2 2h-86c-1.105 0-2-.895-2-2v-47.999c0-1.105-.895-2-2-2l-65-.001" />

        {/* ERRC Conference Room path */}
        <path opacity={path === "ERRC Conference Room" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="M200.5 735.29v1.208c0 1.104-.895 2-2 2H196c-1.104 0-2 .895-2 2v25.792c0 1.105-.895 2-2 2h-86c-1.105 0-2-.896-2-2v-53.499c0-1.105-.895-2-2-2H39.0002c-.5524 0-1.0002-.448-1.0002-1" />

        {/* MIS path*/}
        <path opacity={path === "MIS Office" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.502 727.276-.001-1.002c-.001-1.104-.896-1.998-2-1.998h-46.503c-.827 0-1.498.671-1.498 1.498" />

        {/* Accounting path */}
        <path opacity={path === "Accounting Office" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.502 727.276-.001-1.002c-.001-1.104-.896-1.998-2-1.998l-59.003.001c-.827 0-1.498.67-1.498 1.498" />

        {/* CEAS CR path */}
        <path opacity={path === "CEAS CR" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.502 727.275-.001-1.002c-.001-1.104-.896-1.998-2-1.998l-58.501.001c-1.105 0-2-.896-2-2v-5.502c0-1.104-.895-2-2-2h-2c-1.105 0-2-.895-2-2v-1" />

        {/* to CEAS 2nd floor path */}
        <path opacity={path === "to CEAS 2nd floor" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.502 727.275-.001-1.002c-.001-1.104-.896-1.998-2-1.998H140c-1.105 0-2-.895-2-2v-7.484c0-1.105-.895-2-2-2h-10" />

        {/* CEAS Lab 1 path */}
        <path opacity={path === "CEAS Lab 1" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.502 727.274-.001-1.002c-.001-1.104-.896-1.998-2-1.998H141.5c-1.105 0-2-.896-2-2v-30c0-.829-.672-1.5-1.5-1.5" />

        {/* CEAS Lab 2 path */}
        <path opacity={path === "CEAS Lab 2" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.502 727.274-.001-1.002c-.001-1.104-.896-1.998-2-1.998H141.5c-1.105 0-2-.895-2-2v-48.5c0-.829-.672-1.5-1.5-1.5" />
        ...
        {/* COT Faculty path */}
        <path opacity={path === "COT Faculty" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.502 727.274-.001-1.002c-.001-1.104-.896-1.998-2-1.998H141.5c-1.105 0-2-.896-2-2V657.76c0-1.105-.895-2-2-2H95c-1.1046 0-2-.895-2-2v-28.424c0-.373-.1044-.738-.3014-1.055L81.8014 606.75c-.197-.317-.3014-.682-.3014-1.055v-11.428c0-.828-.6716-1.5-1.5-1.5" />
        ...
        {/* Sewing Lab path */}
        <path opacity={path === "Sewing Lab" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.502 727.273-.001-1.002c-.001-1.104-.896-1.998-2-1.998H141.5c-1.105 0-2-.895-2-2V657.76c0-1.105-.895-2-2-2H95c-1.1046 0-2-.896-2-2v-18.883c0-.802-.4789-1.527-1.2168-1.841l-51.5317-21.931c-.4817-.205-.8638-.591-1.0643-1.074L31 590.285" />

        {/* Near Old Admin Dorm path */}
        <path opacity={path === "Near Old Admin Dorm" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.502 727.273-.001-1.002c-.001-1.104-.896-1.998-2-1.998H141.5c-1.105 0-2-.895-2-2V657.76c0-1.105-.895-2-2-2H95c-1.1046 0-2-.896-2-2v-18.869c0-.809-.4878-1.539-1.2356-1.848l-46.5288-19.244C44.4878 613.49 44 612.76 44 611.951v-47.163c0-.552-.4477-1-1-1" />

        {/* COT Office path */}
        <path opacity={path === "COT Office" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.502 727.274-.001-1.002c-.001-1.104-.896-1.998-2-1.998H141.5c-1.105 0-2-.896-2-2V657.76c0-1.105-.895-2-2-2H95c-1.1045 0-2-.896-2-2v-28.424c0-.373-.1044-.738-.3014-1.055L81.8014 606.75c-.197-.317-.3014-.682-.3014-1.055v-25.926c0-.829-.6717-1.5-1.5-1.5" />

        {/* COT Storage Room path */}
        <path opacity={path === "COT Storage Room" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.502 727.278-.001-1.002c-.001-1.104-.896-1.998-2-1.998H141.5c-1.105 0-2-.895-2-2v-64.514c0-1.104-.895-2-2-2l-42.5.001c-1.1045 0-2-.896-2-2v-28.424c0-.373-.1044-.739-.3014-1.056l-10.8972-17.53c-.197-.317-.3014-.683-.3014-1.056v-54.423c0-.828-.6718-1.5-1.5-1.499" />

        {/* COT Supply Office path */}
        <path opacity={path === "COT Supply Office" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.502 727.278-.001-1.002c-.001-1.104-.896-1.998-2-1.998H141.5c-1.105 0-2-.895-2-2v-64.514c0-1.104-.895-2-2-2l-42.5.001c-1.1045 0-2-.896-2-2v-28.424c0-.373-.1044-.739-.3014-1.056l-10.8971-17.53c-.1971-.317-.3015-.683-.3015-1.056v-67.421c0-.828-.6717-1.5-1.5-1.499" />

        {/* Extension & Production Office path */}
        <path opacity={path === "Extension & Production Office" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.502 727.278-.001-1.002c-.001-1.104-.896-1.998-2-1.998H141.5c-1.105 0-2-.895-2-2v-64.514c0-1.104-.895-2-2-2l-42.5.001c-1.1045 0-2-.896-2-2v-28.424c0-.373-.1044-.739-.3014-1.056l-10.8971-17.53c-.1971-.317-.3015-.683-.3015-1.056v-78.92c0-.828-.6716-1.499-1.5-1.499" />

        {/* Production Office path */}
        <path opacity={path === "Production Office" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.502 727.278-.001-1.002c-.001-1.104-.896-1.998-2-1.998H141.5c-1.105 0-2-.895-2-2v-64.514c0-1.104-.895-2-2-2l-42.5.001c-1.1045 0-2-.896-2-2v-28.424c0-.373-.1044-.739-.3014-1.056l-10.8972-17.53c-.197-.317-.3014-.683-.3014-1.056v-88.418c0-.828-.6716-1.5-1.5-1.5" />

        {/* Production Area path */}
        <path opacity={path === "Production Area" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.502 727.278-.001-1.002c-.001-1.104-.896-1.998-2-1.998H141.5c-1.105 0-2-.895-2-2v-64.514c0-1.104-.895-2-2-2l-42.5.001c-1.1045 0-2-.896-2-2v-28.424c0-.373-.1044-.739-.3014-1.056l-10.8972-17.53c-.197-.317-.3014-.683-.3014-1.056V504.782c0-.828-.6716-1.5-1.5-1.5" />

        {/* New CEAS Room 1 path*/}
        <path opacity={path === "New CEAS Room 1" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.502 727.276-.001-1.003c-.001-1.103-.896-1.998-2-1.998H141.5c-1.105 0-2-.895-2-2v-92.501c0-.828-.672-1.5-1.5-1.5" />
        
        {/* New CEAS Room 2 path */}
        <path opacity={path === "New CEAS Room 2" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.502 727.276-.001-1.002c-.001-1.104-.896-1.998-2-1.998H141.5c-1.105 0-2-.896-2-2V606.274c0-.828-.672-1.5-1.5-1.5" />
        
        {/* New CEAS Room 3 path */}
        <path opacity={path === "New CEAS Room 3" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.502 727.275-.001-1.002c-.001-1.103-.896-1.998-2-1.998H141.5c-1.105 0-2-.895-2-2V589.274c0-.828-.672-1.5-1.5-1.5" />
        
        {/* New CEAS Room 4 path */}
        <path opacity={path === "New CEAS Room 4" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.502 727.276-.001-1.002c-.001-1.104-.896-1.998-2-1.998H141.5c-1.105 0-2-.896-2-2V571.774c0-.828-.672-1.5-1.5-1.5" />
        
        {/* New CEAS Room 5 path */}
        <path opacity={path === "New CEAS Room 5" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.502 727.283-.001-1.003c-.001-1.103-.896-1.997-2-1.997H141.5c-1.105 0-2-.896-2-2V554.281c0-.828-.672-1.5-1.5-1.5" />
        
        {/* New CEAS CR path */}
        <path opacity={path === "New CEAS CR" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.502 727.283-.001-1.003c-.001-1.103-.896-1.998-2-1.998H141.5c-1.105 0-2-.895-2-2V544.278c0-1.104-.895-2-2-2h-13" />

        {/* COT Room 46 path */}
        <path opacity={path === "COT Room 46" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.502 727.282-.001-1.002c-.001-1.104-.896-1.998-2-1.998H141.5c-1.105 0-2-.895-2-2V541.289c0-1.105.895-2 2-2h5.5c1.105 0 2-.896 2-2v-20.501c0-1.104-.895-2-2-2h-40c-1.105 0-2-.895-2-2v-33.999c0-.552.448-1 1-1" />

        {/* Oval path */}
        <path opacity={path === "Oval" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.502 727.283-.001-1.002c-.001-1.104-.896-1.998-2-1.998l-57.001-.001c-1.105 0-2-.895-2-2V541.289c0-1.105.895-2 2-2h5.5c1.105 0 2-.896 2-2v-20.5c0-1.105-.895-2-2-2h-45c-1.105 0-2-.896-2-2V341.501c0-.744.413-1.427 1.072-1.772l9.428-4.938" />

        {/* Grandstand */}
        <path opacity={path === "Grandstand" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.502 727.283-.001-1.003c-.001-1.103-.896-1.998-2-1.998H141.5c-1.105 0-2-.895-2-2V541.289c0-1.105.895-2 2-2h5.5c1.105 0 2-.896 2-2v-20.5c0-1.105-.895-2-2-2h-45c-1.105 0-2-.896-2-2V344.658c0-.243-.0442-.483-.1304-.71l-33.5136-88.22c-.2241-.59-.1567-1.251.1817-1.783L103.5 195.791" />

        {/* Canteen path */}
        <path opacity={path === "Canteen" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.502 727.283-.001-1.003c-.001-1.103-.896-1.998-2-1.998H141.5c-1.105 0-2-.895-2-2V541.289c0-1.105.895-2 2-2h5.5c1.105 0 2-.896 2-2v-20.5c0-1.105-.895-2-2-2h-40c-1.105 0-2-.896-2-2V452.29c0-.553.448-1 1-1" />

        {/* BAC path */}
        <path opacity={path === "BAC Office" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.504 727.276-.001-.998c-.001-1.105.895-2.002 2-2.002h31.499c.827 0 1.498.671 1.498 1.498" />

        {/* Clinic path */}
        <path opacity={path === "Clinic" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.504 727.276-.001-.998c-.001-1.105.895-2.002 2-2.002l43.998-.001c.828 0 1.499.671 1.499 1.499" />

        {/* COE CR path */}
        <path opacity={path === "COE CR" ? "1" : 0} stroke="red" stroke-linecap="round" stroke-opacity=".5" stroke-width="1.5" d="m200.504 727.276-.001-.998c-.001-1.105.895-2.002 2-2.002H243.5c1.105 0 2-.895 2-2v-7.485c0-1.105.895-2 2-2h12" />

        <path fill="#fbff00" stroke="#6e7000" stroke-width=".5" d="M190.5 508.333c1.956.001 3.541 1.587 3.541 3.542 0 1.185-.564 2.161-1.265 2.916-.702.757-1.526 1.275-2 1.538-.174.096-.378.096-.552 0-.474-.263-1.297-.781-1.999-1.538-.702-.755-1.267-1.73-1.267-2.916 0-1.956 1.586-3.542 3.542-3.542Z" />
        <circle cx="190.5" cy="511.875" r="1.375" fill="#fff" stroke="#6e7000" stroke-width=".5" />
        ...
        <path fill="#fffec6" stroke="#ea8228" stroke-width=".5" d="M198.742 729.458c0-.095 0-.142.029-.171.03-.029.077-.029.171-.029h3.284c.094 0 .141 0 .17.029.03.029.03.076.03.171v4.085c0 .095 0 .142-.03.171-.029.029-.076.029-.17.029h-3.284c-.094 0-.141 0-.171-.029-.029-.029-.029-.076-.029-.171z" />
        <path stroke="#f55456" stroke-linecap="round" stroke-width=".6" d="M200.584 732.648v.024" />
        <rect width=".68" height=".683594" x="199.643" y="730.193" fill="#65a468" rx=".1" />
        <rect width=".68" height=".683594" x="200.844" y="730.193" fill="#657ea4" rx=".1" />
        <rect width=".68" height=".683594" x="199.643" y="731.247" fill="#a48765" rx=".1" />
        <rect width=".68" height=".683594" x="200.844" y="731.247" fill="#a46566" rx=".1" />
        <path fill="#8cd200" d="M351 759h109v27.4194H351z" />
        <path fill="#6eaa00" d="M351 786.419h109V789H351z" />
        <path fill="#bf71ff" d="M80 404h7v13h-7z" />
        <path fill="#9e5ed3" d="M80 417h7v2h-7z" />
      </svg>
